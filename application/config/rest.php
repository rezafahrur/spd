...
| 
 */
//$config['rest_server']	= 'http://localhost/codeigniter-rest-example/index.php/rest_server/';
$config['rest_server']	= site_url('rest_server').'/';   //don't forget the trailing slash
