...
<html lang="en">
      ...
      <header class="header black-bg">
            ...
            <div class="nav notify-row" id="top_menu">
                <ul class="nav top-menu">
				   <a href="#"  > <font color="ffffff"> <i class="fa fa-user fa-2x"></i> <?php echo $this->session->userdata("NamaPengguna"); ?>
                         </font></a> 
				</ul> 
				</div>
				<!-- logout -->
  ...
  echo form_open('PengelolaanPengguna/manajemenAkun/'.$hasil -> idPengguna, $atribut); 	
						?>
