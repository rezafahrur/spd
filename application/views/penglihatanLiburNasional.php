      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Daftar Libur Nasional Perusahaan</h3>
			<hr>
          	<div class="row mt">
          		<div class="col-lg-12">
                	<div class="alert alert-info alert-dismissable">
						  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
						  <strong>Perhatian!</strong> Ubahlah Setiap Tahun Untuk Keperluan Cuti. Terima Kasih :)
						</div> 
				<div class="panel panel-default">
                        <div class="panel-heading" align="right">
                           <?php 
							...
							echo anchor('PengelolaanLiburNasional/menambahLiburNasional','<i class="fa fa-plus-circle"> </i> &nbsp Tambah Jadwal Libur', $data2); ?> 
                        </div>
                        <!-- /.panel-heading 1 -->
				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tabelliburnasional" >
                                   <thead>
									<tr>
										<th> No </th>
										<th> Tanggal Libur </th>
									...
									<tr> 
										...
										<td class="center"> <?php echo $data->tanggal_libur; ?> </td>
										<td class="center"> <?php echo $data->keterangan; ?> </td>
										<td class="center"> 
			
			<a href="mengubahLiburNasional/<?php echo $data ->id_libur; ?>" class="btn btn-primary"> <i class="fa fa-pencil"></i>
			
	       						Ubah </a> 
								
		 <a href="menghapusLiburNasional/<?php echo $data ->id_libur; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin Ingin Menghapus Tanggal <?php echo $data->tanggal_libur; ?>  dari Daftar Libur Nasional Perusahaan?')">  <i class="fa fa-trash-o"></i> &nbsp
