...
<html lang="en">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Ubah Karyawan Kontrak</h3>
          	<div class="row mt">
          		<div class="col-lg-10">
				<?php 
						$atribut = array(
  ...
  echo form_open('PengelolaanKaryawanKontrak/memanggilWebServiceMengubahKaryawan/'.$hasil -> nrp, $atribut); 	
						?>
