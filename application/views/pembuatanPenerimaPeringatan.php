      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Tambah Penerima Peringatan</h3>
          	<div class="row mt">
          		<div class="col-lg-10">
				<?php
					//untuk keperluan form validasi
					$atribut = array( 
								'id' => 'pembuatanPenerimaPeringatan'
								); 
  					echo form_open('pengelolaanPenerimaPeringatan/membuatPenerimaPeringatan', $atribut); 	
				?>
...
<div class="form-group">
	 <label>Akan Dikirim Laporan Kontrak? &nbsp;&nbsp;<span id="blinker" style="color:red">(Tekan Salah Satu)</span> </label>
	 <select name="peringatanKontrak" multiple class="form-control required">
						  <option  value="1">Iya</option>
						  <option value="0">Tidak</option>
						</select>
			</div>
<div class="form-group">
	 <label>Akan Dikirim Laporan Absensi Tidak Ada Jam Keluar? &nbsp;&nbsp;<span id="blinker1" style="color:red">(Tekan Salah Satu)</span></label>
	<select name="peringatanJamKeluar" multiple class="form-control required">
						  <option  value="1">Iya</option>
						  <option value="0">Tidak</option>
						</select>
			</div>
...
<?php echo form_close(); ?>
	...
	<script type="text/javascript"> window.onload = date_time('date_time');</script>
		<script>$(document).ready(function() {
				$("#pembuatanPenerimaPeringatan").validate();
			});
		</script>
 ...
 <script>
	...
	var t = setInterval(function (){
		var ele = 
		document.getElementById('blinker1');
		 ele.style.visibility =
		 (ele.style.visibility == 'hidden' ?
		 '' : 'hidden');
		 }, blink_speed);
