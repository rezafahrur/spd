  ...
  <section id="container" >
	...
	<p class="centered"> <img src="../assets/img/jam.gif" class="img-circle" height="80" width="80"></p>
		...
		<li class="mt">
			 ...
			 <li class="mt">
                      <a href="../pengelolaanKaryawanKontrak">
                          <i class="fa fa-th"></i>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Daftar Penerima Peringatan</h3>
			<hr>
          	<div class="row mt">
          		<div class="col-lg-12">
				...
				<div class="panel panel-default">
                        <div class="panel-heading" align="right">
                           <?php 
							...
							echo anchor('pengelolaanPenerimaPeringatan/membuatPenerimaPeringatan','<i class="fa fa-plus-circle"> </i> &nbsp Tambah Penerima Peringatan', $data2); ?> 
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tabelpenerimaperingatan" >
                                   <thead>
									<tr>
										<th> No </th>
										<th class="text-center"> Nama </th>
										<th class="text-center"> Alamat Email</th>
										<th class="text-center"> Peringatan Kontrak</th>
										<th class="text-center"> Peringatan Tidak Ada Absensi Jam Keluar</th>
									...
									<tr> 
										...
										<td class="center"> <?php echo $data->NamaPenerimaPeringatan; ?> </td>
										<td class="center"> <?php echo $data->EmailPenerimaPeringatan; ?> </td>
										<td class="text-center"> <?php if($data->PeringatanKontrak == 1) echo "Iya"; else echo "Tidak"; ?> </td>
										<td class="text-center"> <?php if($data->PeringatanJamKeluar == 1) echo "Iya"; else echo "Tidak"; ?> </td>
										<td class="center"> 
			
			<a href="mengubahPenerimaPeringatan/<?php echo $data ->idPenerimaPeringatan; ?>" class="btn btn-primary"> <i class="fa fa-pencil"></i>
			
	       						Ubah </a> 
								
		 <a href="menghapusPenerimaPeringatan/<?php echo $data ->idPenerimaPeringatan; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin Ingin Menghapus  <?php echo $data->NamaPenerimaPeringatan; ?>  dari Daftar Penerima Peringatan?')">  <i class="fa fa-trash-o"></i> &nbsp
	...
	<script type="text/javascript"> window.onload = date_time('date_time');</script>
	 <script>
        $(document).ready(function () {
            $('#tabelpenerimaperingatan').dataTable();
        });
    </script>
