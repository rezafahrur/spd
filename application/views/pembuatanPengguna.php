      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Tambah Pengguna</h3>
          	<div class="row mt">
          		<div class="col-lg-10">
				<?php
				    // untuk keperluan form validasi
					$atribut = array( 
								'id' => 'pembuatanPengguna'
								); 
  					echo form_open('PengelolaanPengguna/menambahPengguna', $atribut); 	
				?>
...
<div class="form-group">								
	<label>Hak Akses &nbsp;&nbsp;<span id="blinker" style="color:red">(Tekan Salah Satu)</span></label>
	<select name="hakAkses" multiple class="form-control required">
