...
<html>
		...
		<div id="fh5co-main-content">
			<div class="fh5co-post"> 
				<div class="fh5co-entry padding">
					<div>
						<p>Untuk Menyalakan fitur pengiriman otomatis kembali, yang perlu anda lakukan adalah  adalah sebagai berikut</p>
						<h2><b>Untuk Pengiriman Kontrak</b></h2>
						<p>
						...
						<p>
						4. Pada Jendela centang Enabled kemudian tekan "OK" 
						</p>
						<p>
						<img src="<?php echo base_url() ?>assets/faq/images/task17.PNG" >
						</p>
						<h2><b>Untuk Pengiriman Absensi Jam Keluar</b></h2>
						<p>
						...
						<p>
						<img src="<?php echo base_url() ?>assets/faq/images/task18.PNG" >
						</p>
					</div>
				</div>
	...
	<div class="fh5co-navigation">
		<div class="fh5co-cover prev fh5co-cover-sm" style="background-image: url(<?php echo base_url() ?>assets/faq/images/project-1.jpg)">
			...
			<a class="copy" href="<?php echo base_url() ?>earlyWarning/faq/3">
				<div class="display-t">
		...
		<div class="fh5co-cover next fh5co-cover-sm" style="background-image: url(<?php echo base_url() ?>assets/faq/images/project-5.jpg)">
			<div class="overlay"></div>
			<a class="copy" href="<?php echo base_url() ?>earlyWarning/faq/5">
				<div class="display-t">
					<div class="display-tc">
						<div>
