...
<html>
		...
		<div id="fh5co-main-content">
			<div class="fh5co-post"> 
				<div class="fh5co-entry padding">
					<div>
						<p>
						Ada dua hal mengapa sistem tidak mengirimkan laporan peringatan kepada anda yaitu
						<ul>
							<li>Tidak Ada Karyawan Kontrak yang akan habis masa kontraknya maupun Karyawan yang tidak ada absen jam keluarnya tidak ada pada sistem perusahaan anda.</li>
							<li>Komputer Server Tidak Terhubung ke jaringan internet atau jaringan internet sedang <i>down</i> ataupun komputer server anda sedang mengalami <i>maintenance</i> segera periksa kembali jaringan internet maupun komputer server anda untuk menangani masalah ini</li>
						</ul>
						</p>
						<p align="justify">
						Jika masalah diatas dapat dipecahkan maka sistem ini akan tetap mengirimkan peringatan kepada anda selama anda tidak menonaktifkan Windows Task Scheduler pada komputer server anda, untuk itu anda perlu mengaktifkannya kembali <a href="<?php echo base_url() ?>earlyWarning/faq/4"> (lihat pertanyaan 4)</a>.
						</p>
					</div>
				</div>
	...
	<div class="fh5co-navigation">
		...
		<div class="fh5co-cover next fh5co-cover-sm" style="background-image: url(<?php echo base_url() ?>assets/faq/images/project-5.jpg)">
			<div class="overlay"></div>
			<a class="copy" href="<?php echo base_url() ?>earlyWarning/faq/1">
				<div class="display-t">
					<div class="display-tc">
						<div>
							<span>Pertanyaan Selanjutnya</span>
							<h2>Apa Itu Windows Task Scheduler?</h2>
						</div>
					</div>
				</div>
			</a>
