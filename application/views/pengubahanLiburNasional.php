      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Ubah Jadwal Libur Nasional Perusahaan</h3>
          	<div class="row mt">
          		<div class="col-lg-10">
				<?php 
						$atribut = array(
									'id' => 'pengubahanLiburNasional'
									);
  echo form_open('PengelolaanLiburNasional/mengubahLiburNasional/'.$hasil -> id_libur, $atribut); 	
						?>
