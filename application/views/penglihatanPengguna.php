	...
	<p class="centered"> <img src="<?php echo base_url()?>assets/img/jam.gif" class="img-circle" height="80" width="80"></p>
		...
		<li class="mt">
			 ...
			 <li class="mt">
			   ...
			   <li class="mt">
                      <a class="active" href="<?php echo base_url()?>pengelolaanPengguna">
                          <i class="fa fa-th"></i>
				...
				<div class="panel panel-default">
                        <div class="panel-heading" align="right">
                           <?php 
							...
							echo anchor('PengelolaanPengguna/menambahPengguna','<i class="fa fa-plus-circle"> </i> &nbsp Tambah Pengguna', $data2); ?> 
                        </div>
                        <!-- /.panel-heading 1 -->
				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tabelpengguna" >
                                   <thead>
									<tr>
										<th> No </th>
										<th> Nama </th>
									...
									<tr> 
										...
										<td class="center"> <?php echo $data->NamaPengguna; ?> </td>
										<td class="center"> <?php echo $data->Username; ?> </td>
										<td class="center"> <?php echo $data->nrp; ?> </td>
										<td class="center"> <?php echo $data->Email; ?> </td>
										<td class="center"> <?php echo $data->HakAkses; ?> </td>
										<td class="center"> 
			
			<a href="mengubahPengguna/<?php echo $data ->idPengguna; ?>" class="btn btn-primary"> <i class="fa fa-pencil"></i>
			
	       						Ubah </a> 
								
		 <a href="menghapusPengguna/<?php echo $data ->idPengguna; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin Ingin Menghapus  <?php echo $data->NamaPengguna; ?>  dari Daftar Pengguna Sistem ini?')">  <i class="fa fa-trash-o"></i> &nbsp
